# Member-related utility functions
# These functions were moved from app/utils.py as they are specific to member functionality
...
def get_member_data(member, show_private_data=False):
    """
